...
common_English_words = ('1', '2', '3', '4', '5', '6', '7', '8', '9', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h',
                        ...
                        'her', 'she', 'or', 'an', 'will', 'my', 'one', 'all', 'would', 'there', 'their', 'to',
                        'of', 'in', 'for', 'on', 'with', 'at', 'by', 'from', 'up', 'about', 'into', 'over', 'after',
                        'over', 'after', 'beneath', 'under', 'above', 'be', 'do', 'we', 'say', 'what', 'so', 'me',
                        'when', 'who', 'where', 'get', 'which', 'just', 'no', 'yes', 'your', 'some', 'could', 'them',
                        'see', 'than', 'then', 'its', 'also', 'how', 'our', 'us', 'any', 'let', 'can\'t', 'won\'t',
